...
3. Add [Flutter](/docs/logger/flutter) or [Dio](/docs/logger/dio) depending on your app shape.
4. Add [File logging](/docs/logger/file), [Navigation](/docs/logger/navigation), and [Sharing](/docs/logger/share) as focused extensions.